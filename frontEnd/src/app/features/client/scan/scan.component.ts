...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-surface flex flex-col items-center justify-center p-6 animate-fade-in relative overflow-hidden">
      ...
      @if (status() === 'loading') {
        <div class="h-16 w-16 mb-6 relative z-10">
          <span class="animate-spin block h-full w-full border-4 border-primary border-t-transparent rounded-full drop-shadow-lg"></span>
        </div>
